...
int main(void) {
  ...
  while (shipping != 1) {
    ...
    case 'u':
      ...
      case 'S':
        ...
        printf("Standard shipping set\n");
        shipping = 1;
        printf("Shipping is set to %d", shipping);
        break;
      case 'e':
      case 'E':
        ship1 = "Expedited";
        shipcost = USA_EXPEDITED_SHIPPING;
        printf("Expedited shipping set");
        shipping = 1;
        printf("Shipping is set to %d", shipping);
        break;
      }
    ...
    default:
      printf("Invalid shipping destination. Defaulting to USA standard "
             "shipping.\n");
      shipping = 1;
  ...
  printf("-------------------------------------------------------\n");
  printf("Shirts\t\t%d\t\t$%.2f\t\t$%.2f\n", shirtQuantity, SHIRT_PRICE,
         shirtQuantity * SHIRT_PRICE);
  printf("Shoes\t\t%d\t\t$%.2f\t\t$%.2f\n", shoeQuantity, SHOE_PRICE,
         shoeQuantity * SHOE_PRICE);
